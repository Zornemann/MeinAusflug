...
APP_URL = os.getenv("APP_URL") or os.getenv("RENDER_EXTERNAL_URL") or "https://meinausflug.onrender.com"
APP_ICON_URL = os.getenv("APP_ICON_URL") or "https://github.com/Zornemann/MeinAusflug/blob/main/MeinAusflug.jpg?raw=true"
